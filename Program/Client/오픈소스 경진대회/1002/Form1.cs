...
namespace _1002
{
    ...
    public partial class Form1 : Form 
    {
        ...
        {
            var config = SpeechConfig.FromSubscription("b26fae78608d4f75bab063864590a96b", "koreacentral");
                ...
                using (var recognizer = new SpeechRecognizer(config))
                {
                    ...
                    if (result1.Reason == ResultReason.RecognizedSpeech)
                    {
                        if (result1.Text.Contains("시리"))
                        {
                            ...
                            else if (result2.Text.Contains("근처") || result2.Text.Contains("가까"))
                            {
                                ko.ConnectApi("알겠어요");
                            ...
                            else if (result2.Text.Contains("밥") && result2.Text.Contains("먹었"))
                            {
                                ko.ConnectApi("배터리 백퍼센트입니다");
                            }
                            else if (result2.Text.Contains("자기소개"))
                            {
